      ...
      contents: [
        ...
        // 環境変数 or 設定ファイルで店舗ごとのPayment Link URLを管理
        {
          ...
          action: {
            ...
            uri: "https://buy.stripe.com/example",
          },
        },
      ],
    },
      ...
      contents: [
        {
          ...
          color: C.accent,
          height: "md",
          action: { type: "uri", label: "オンライン予約", uri: "https://example.com/reserve" },
        },
        {
          type: "button",
          style: "secondary",
  ...
  return {
    ...
    header: {
      ...
      contents: [
        ...
        { type: "text", text: "よくある質問", color: C.text, weight: "bold", size: "xl", margin: "sm" },
      ],
    },
    body: {
      type: "box",
